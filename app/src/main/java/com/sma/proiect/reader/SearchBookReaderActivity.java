...
public class SearchBookReaderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        broadcastNotificationManagerForFunction.createNotificationChannel(SearchBookReaderActivity.this);
        ...
        ArrayAdapter<String> searchTypeAdapter = new ArrayAdapter<>(SearchBookReaderActivity.this, android.R.layout.simple_spinner_item, new String[]{"Title", "ISBN"});
